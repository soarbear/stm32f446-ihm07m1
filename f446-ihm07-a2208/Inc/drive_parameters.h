...
#define MAX_APPLICATION_SPEED_RPM       13614 /*!< rpm, mechanical */
...
#define PLL_KP_GAIN                      2716
#define PLL_KI_GAIN                      120
...
#define PID_TORQUE_KP_DEFAULT         1331
#define PID_TORQUE_KI_DEFAULT         1233
#define PID_TORQUE_KD_DEFAULT         100
#define PID_FLUX_KP_DEFAULT           1331
#define PID_FLUX_KI_DEFAULT           1233
...
#define PID_SPEED_KP_DEFAULT          2531/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT          1029/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
...
#define DEFAULT_CONTROL_MODE           STC_SPEED_MODE /*!< STC_TORQUE_MODE or
                                                        STC_SPEED_MODE */
#define DEFAULT_TARGET_SPEED_RPM      2543
...
#define PHASE1_FINAL_CURRENT           10026
/* Phase 2 */
#define PHASE2_DURATION                5652 /*milliseconds */
#define PHASE2_FINAL_SPEED_UNIT         (2826*SPEED_UNIT/_RPM)
#define PHASE2_FINAL_CURRENT           10026
/* Phase 3 */
#define PHASE3_DURATION                0 /*milliseconds */
#define PHASE3_FINAL_SPEED_UNIT         (2826*SPEED_UNIT/_RPM)
#define PHASE3_FINAL_CURRENT           10026
/* Phase 4 */
#define PHASE4_DURATION                0 /*milliseconds */
#define PHASE4_FINAL_SPEED_UNIT         (2826*SPEED_UNIT/_RPM)
#define PHASE4_FINAL_CURRENT           10026
/* Phase 5 */
#define PHASE5_DURATION                0 /* milliseconds */
#define PHASE5_FINAL_SPEED_UNIT         (2826*SPEED_UNIT/_RPM)
...
#define OBS_MINIMUM_SPEED_RPM          2543
